...
namespace EasyTransition
{
    ...
    {        
        ...
        public void TransitionWithLoading(string targetScene, TransitionSettings transition, float startDelay)
        {
            if (transition == null || runningTransition)
                return;
            ...
            StartCoroutine(LoadViaLoadingScene(startDelay, transition));
        }
        ...
        IEnumerator LoadViaLoadingScene(float startDelay, TransitionSettings transitionSettings)
        {
            yield return new WaitForSecondsRealtime(startDelay);
